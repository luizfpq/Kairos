create function inserir_usuario(nome_digitado 	character varying,
								login_digitado 	character varying,
								senha_digitado 	character varying,
								email_digitado 	character varying,
								tipo_digitado	character varying,
								nivel_digitado	integer,
...
alter function inserir_usuario(varchar, varchar, varchar, varchar, varchar, integer, bigint) owner to zvraimhwsxhxda;
