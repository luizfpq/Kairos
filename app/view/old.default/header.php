			...
			<nav class="col">
		      <ul class="nav justify-content-center">
				  ...
				  <li class="nav-item">
				    <?php
				  	if($page_subject == "Activity")
				    	echo '<a class="nav-link active" href="?controller=Activity&action=activity"><i class="fa fa-tasks"></i> Atividades</a>';
				    else
				  ...
				  <li class="nav-item">
				    <?php
				  	if($page_subject == "Activity")
				    	echo '<a class="nav-link active" href="?controller=Activity&action=activity"><i class="fa fa-tasks"></i> menu novo</a>';
				    else
