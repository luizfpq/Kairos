...
<!-- Conteudo -->
		<div class="content col-10">
			<form class="container-fluid" action="index.php?controller=Atividade&action=reprova&id_atividade=<?php echo $atividade->getIdAtividade(); ?>" method="post">
				<div class="row">
					<div class="col">
						<h1>Deseja reprovar a atividade?</h1>
